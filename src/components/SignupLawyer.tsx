  ...
  <section className="flex justify-center items-center min-h-[60vh] bg-gradient-to-b from-white to-blue-50 px-3 py-12">
    <div className="bg-white rounded-xl shadow-xl border border-gray-200 p-8 w-full max-w-md">
      ...
      <form className="flex flex-col gap-4">
        <input type="text" placeholder="Name" className="px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400" required />
        ...
        <input type="text" placeholder="License Number" className="px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400" required />
        <button type="submit" className="px-6 py-3 bg-blue-700 text-white rounded-lg font-semibold hover:bg-blue-800 transition">Signup</button>
      </form>
    </div>
  </section>
);
